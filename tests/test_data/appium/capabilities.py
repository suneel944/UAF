class Capabilities:
    ...
    def set_mobile_native_app_capabilities(self, **kwargs):
        ...
        self.__mobile_native_app_capabilities["platformName"] = kwargs.get(
            "platform_name"
        ).value
        ...
        self.__mobile_native_app_capabilities["automationName"] = kwargs.get(
            "automation_name"
        ).value
    ...
    def set_mobile_web_browser_capabilities(self, **kwargs):
        ...
        if kwargs.__len__() < 1:
            raise ValueError("Missing keyword arguments!")
        self.__mobile_web_browser_capabilities["platformName"] = kwargs.get(
            "platform_name"
        ).value
        ...
        self.__mobile_web_browser_capabilities["automationName"] = kwargs.get(
            "automation_name"
        ).value
        self.__mobile_web_browser_capabilities["browserName"] = kwargs.get(
            "browser_name"
        ).value
    ...
    def set_mobile_hybrid_app_capabilities(self, **kwargs):
        ...
        if kwargs.__len__() < 1:
            raise ValueError("Missing keyword arguments!")
        self.__mobile_hybrid_app_capabilities["platformName"] = kwargs.get(
            "platform_name"
        ).value
        ...
        self.__mobile_hybrid_app_capabilities["automationName"] = kwargs.get(
            "automation_name"
        ).value
        self.__mobile_hybrid_app_capabilities["browserName"] = kwargs.get(
            "browser_name"
        ).value
